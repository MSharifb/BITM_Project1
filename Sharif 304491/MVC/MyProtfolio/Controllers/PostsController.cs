...
namespace MyProtfolio.Controllers
{
    ...
    {
        private MyProtfolioEntities db = new MyProtfolioEntities();
        ...
        public ActionResult Create([Bind(Include = "ID,AuthorID,CategoryID,SubCategoryID,PublishdDate,Title,ShortDescription,Description,PostImage,Status,URL")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,AuthorID,CategoryID,SubCategoryID,PublishdDate,Title,ShortDescription,Description,PostImage,Status,URL")] Post post)
        {
            if (ModelState.IsValid)
            {
