                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <asp:TextBox ID="txtSubject" runat="server" placeholder="Enter category" CssClass="form-control"></asp:TextBox>
                            </div>
                                ...
                                <asp:GridView ID="gvSubject" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" OnRowCommand="gvSubject_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdnSubjectSId" runat="server" Value='<%# Eval("SubjectId") %>' />
